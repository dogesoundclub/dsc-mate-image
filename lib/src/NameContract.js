...
class NameContract extends Contract_1.default {
    constructor() {
        super("0x12C591fCd89B83704541B1Eac6b4aA18063A6954", require("./NameContractABI.json"));
    }
    async set(mateId, name) {
        const register = Klaytn_1.default.walletAddress;
        await this.contract.methods.set(mateId, name).send({ from: register, gas: 1500000 });
    }
